...
const SearchService = {
    getRepositories: async function(word, page){
        try {
            const res = await Axios.get(
                `${process.env.REACT_APP_API}/repositories?q=${word}&page=${page}`,
                API_HEADER_CONFIG
            )
            return res.data;
        } catch (error) {
    ...
    getCode: async function(word, page){
        try {
            const res = await Axios.get(
                `${process.env.REACT_APP_API}/code?q=${word}&page=${page}`,
                API_HEADER_CONFIG
            )
            return res.data;
        } catch (error) {
    ...
    getUsers: async function(word, page){
        try {
            const res = await Axios.get(
            `${process.env.REACT_APP_API}/users?q=${word}&page=${page}`,
                API_HEADER_CONFIG
            )
            return res.data;
        } catch (error) {
